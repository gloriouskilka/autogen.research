...
Напиши правила этого нового Autogen фреймворка, которые будут переданы профессиональной команде Python разработчиков с IQ 140, специализирующейся на разработке Python, но никогда не работавшей с Autogen фреймворком. Приводи примеры, правила, Best practices. Напиши 2 полностью рабочих агентских приложения, демонстрирующие ВСЕ указанные фичи Autogen в коде - необходимо продемонстировать недетерминированные (LLM) агенты и возможность писать детерменированные, без вызова LLM. Не пиши долгие комментарии там, где и так будет понятно профессионалу в Python. Когда пишешь ответ, используй английский. No yapping!